            ...
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-row relative items-center justify-center max-sm:justify-start px-10 gap-9">
                    ...
                    <div className="flex flex-row gap-7">
                        <Link href="https://t.me/lama_cash" className="items-center justify-center flex">
                        ...
                        <Link href="https://www.tiktok.com/@lama.change" className="items-center justify-center flex">
                        ...
                        <Link href="https://www.instagram.com/lama_cash" className="items-center justify-center flex">
                        ...
                        <Link href="https://youtube.com/@lama_cash?si=COXy_OKci7oiECin" className="items-center justify-center flex">
