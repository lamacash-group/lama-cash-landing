        ...
        <footer className="w-full h-full min-h-50 bg-[rgba(23,23,23,1)] py-10 relative bg-[linear-gradient(90deg,rgba(113,52,194,1)_-40%,rgba(23,23,23,1)_40%)]">
            <div className="flex flex-col gap-10">
                <div className="flex flex-row gap-20 max-sm:gap-10 justify-center items-center px-9">
                    <div className="flex flex-col gap-1.5 w-full justify-center items-center text-center font-rubik text-[rgba(240,240,240,1)] max-w-75">
                        ...
                        <Link href="https://t.me/lama_cash_manager" target="_blank" rel="noopener" className="w-full items-center justify-center flex mt-4 min-h-6 min-w-6">
                        <Button
                        ...
                        <div className="w-full flex flex-col justify-center items-center gap-2 text-base max-sm:text-[9px] text-white">
                            <nav className="flex flex-col gap-2 items-center">
                                <Link href="/about" className="hover:text-white transition-colors duration-300">Про нас</Link>
                                <Link href="/contacts" className="hover:text-white transition-colors duration-300">Контакти</Link>
                                <Link href="/privacy" className="hover:text-white transition-colors duration-300">{t('policy')}</Link>
                                <Link href="/legal" className="hover:text-white transition-colors duration-300">{t('legal')}</Link>
                            </nav>
                        </div>
                    </div>
                ...
                <div className="flex flex-row relative items-center justify-center max-sm:justify-start px-10 gap-9">
                    ...
                    <div className="flex flex-row gap-7">
                        <Link href="https://t.me/lama_cash" target="_blank" rel="noopener" aria-label="Telegram" className="items-center justify-center flex">
                        ...
                        <Link href="https://www.tiktok.com/@lama.change" target="_blank" rel="noopener" aria-label="TikTok" className="items-center justify-center flex">
                        ...
                        <Link href="https://www.instagram.com/lama_cash" target="_blank" rel="noopener" aria-label="Insagram" className="items-center justify-center flex">
                        ...
                        <Link href="https://youtube.com/@lama_cash?si=COXy_OKci7oiECin" target="_blank" rel="noopener" aria-label="Youtube" className="items-center justify-center flex">
